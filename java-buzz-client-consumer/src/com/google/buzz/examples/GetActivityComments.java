...
public class GetActivityComments
{
        ...
        throws BuzzAuthenticationException, IOException, BuzzIOException, BuzzParsingException
    {
         ...
         */
        BuzzFeed feed = buzz.getComments( userId, activityId );
        ...
        if ( !feed.getEntries().isEmpty() )
        {
            ...
            {
                System.out.print( "Comment Title: " + entry.getContent().getText() );
                System.out.println( " | Comment Date: " + entry.getPublished() );
            }
        }
        else
        {
