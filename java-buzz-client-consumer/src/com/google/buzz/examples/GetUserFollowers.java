...
/**
 * This example class demonstrates how to use the <b>Buzz.java</b> API to retrieve the user
 * followers list.
 * 
...
public class GetUserFollowers
{
        ...
        throws BuzzAuthenticationException, IOException, BuzzIOException, BuzzParsingException
    {
        ...
        /**
         * Execute API method to retrieve the list of people that are following the user.
         */
        List<BuzzUserProfile> response = buzz.followers( userId );
        ...
        {
            System.out.println( "Nobody is following the user" );
        }
